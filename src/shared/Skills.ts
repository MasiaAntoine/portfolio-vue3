...
export const skills: SkillCategory[] = [
  {
    ...
    color: 'bg-blue-500',
    skills: [
      { name: 'Vue.js', level: 4, icon: 'V', color: 'bg-green-500' },
      { name: 'TypeScript', level: 4, icon: 'TS', color: 'bg-blue-600' },
      { name: 'Tailwind', level: 5, icon: 'T', color: 'bg-cyan-500' },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'Laravel', level: 4, icon: 'L', color: 'bg-red-600' },
      { name: 'Java', level: 3, icon: '☕', color: 'bg-orange-500' },
      { name: 'Spring Boot', level: 3, icon: '🍃', color: 'bg-green-700' },
  ...
  },
  {
    ...
    color: 'bg-indigo-500',
    skills: [
      { name: 'Capacitor', level: 3, icon: '⚡', color: 'bg-blue-500' },
      { name: 'iOS', level: 2, icon: '🍎', color: 'bg-gray-800' },
      { name: 'Android', level: 2, icon: '🤖', color: 'bg-green-500' },
    ],
  },
  {
    ...
    color: 'bg-gray-500',
    skills: [
      { name: 'Visual Studio Code', level: 5, icon: '📝', color: 'bg-blue-600' },
      { name: 'Wix', level: 5, icon: '🎨', color: 'bg-blue-500' },
      { name: 'Canva', level: 5, icon: '🎭', color: 'bg-purple-500' },
      { name: 'Git', level: 4, icon: '📊', color: 'bg-orange-600' },
      { name: 'GitHub', level: 4, icon: '🐙', color: 'bg-gray-800' },
      { name: 'Slack', level: 4, icon: '💬', color: 'bg-purple-600' },
      { name: 'Element', level: 3, icon: '🔗', color: 'bg-green-600' },
      { name: 'Notion', level: 4, icon: '📋', color: 'bg-gray-700' },
      { name: 'Teams', level: 4, icon: '🤝', color: 'bg-blue-700' },
    ],
  },
]
